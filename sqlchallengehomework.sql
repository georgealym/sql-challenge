...
---3. List the manager of each department with the following information: department number, department name, the manager's employee number, last name, first name, and 
...
SELECT 	dept_manager.dept_no as "Department Number",
		...
		employees.hire_date as "Department Manager Hire Date"
FROM dept_manager
